locals {
  monitoring_role_arn = var.create_monitoring_role ? aws_iam_role.monitoring_role[0].arn : var.monitoring_role_arn
...
resource "aws_db_instance" "rpost_db" {
 ...
 #option_group_name      = var.option_group_name
  ...
  depends_on = [aws_cloudwatch_log_group.rpost-logs]
...
resource "aws_cloudwatch_log_group" "rpost-logs" {
